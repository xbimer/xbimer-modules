...
typedef		GS::HashTable<UIndex, StructureComponentId>	BodyIdxToComponentIdxMap;
...
public:
	...
	static ModelCalculations::ProjectionSurfaceRef	GetWallProjectionSurface (VBElem::WallConstRef wall, const StructureComponentId& structureComponentId);
	static ModelCalculations::ProjectionSurfaceRef	GetBeamProjectionSurface (VBElem::BeamConstRef beam, const StructureComponentId& structureComponentId);
	static ModelCalculations::ProjectionSurfaceRef	GetColumnProjectionSurface (VBElem::ColumnConstRef column, const StructureComponentId& structureComponentId);
	...
	static ModelCalculations::ProjectionSurfaceRef	GetShellProjectionSurface (VBElem::ShellConstRef shell, const Modeler::ConstElemPtr& refElem, const BodyIdxToComponentIdxMap& bodyIdxToComponentIdxMap, const StructureComponentId& structureComponentId);
