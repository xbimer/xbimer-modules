...
public:
	virtual ~Object ();
			...
			Object (const ODB::DynamicClass* finalDynamicClass, const Parameters&... parameters);
...
public:
	...
	virtual	GSErrCode	WriteTWIsolatedState	(GS::OChannel& oc) const;
	virtual	GSErrCode	ReadTWIsolatedState		(GS::IChannel& ic);
...
template<typename... Parameters>
TW::Object::Object (const ODB::DynamicClass* finalDynamicClass, const Parameters&... parameters): 
	ODB::DynamicObject (finalDynamicClass, parameters...)
{
}
