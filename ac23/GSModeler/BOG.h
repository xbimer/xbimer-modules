...
GSMODELER_DLL_EXPORT
void		BOGElemBegin (GDL3DComponent component);
...
GSMODELER_DLL_EXPORT
void BOGBody (
		GDL3DComponent component, const Modeler::MeshBody& baseElem, const TRANMAT& tran, short defaultColor, GSAttributeIndex defaultGlima, Int32 defaultEdgeStatus,
		const GS::Array<GSAttributeIndex> *glimaPerPoly = nullptr, const GS::Array<short> *colorPerEdge = nullptr, const GS::Array<Int32> *statusPerEdge = nullptr
	);
