...
typedef void GPU_CALL	ExecValueScript_Proc (Int32 id, GSUserData* userDataPtr, GDL::Parameters* addPars);
typedef void GPU_CALL	RunScriptForWireFrame_Proc (Int32 id, GSUserData* userDataPtr, const GDL::Parameters& addPars, const TRANMAT* tran);
typedef void GPU_CALL	DrawWireFrame_Proc (Int32 id, GSUserData* userDataPtr, const GDL::Parameters& addPars, const TRANMAT* tran);
...
GDLPARAMUI_DLL_EXPORT
void		GPU_CALL		HSEndModel (Int32 id, const GDL::Parameters* addPars = nullptr);

GDLPARAMUI_DLL_EXPORT
bool		GPU_CALL		HSInitDrag (Int32 id, GSUserData* userDataPtr, ULong* hsUnIDs, ULong* hsNum, const Coord3D* firstClick,
										const GDL::Parameters& addPars, DragSpace_t* drSpace = nullptr);

GDLPARAMUI_DLL_EXPORT
bool		GPU_CALL		HSDragPrep (Int32 id, Coord3D* inoutCoord);

GDLPARAMUI_DLL_EXPORT
bool		GPU_CALL		HSDragSetParams (Int32 id, const GDL::Parameters& addPars, Coord3D* outCoord);

GDLPARAMUI_DLL_EXPORT
bool		GPU_CALL		HSDragDraw (Int32 id);

GDLPARAMUI_DLL_EXPORT
bool		GPU_CALL		HSGiveParams (Int32 id, TRANMAT* tran, GDL::Parameters* addPars);
