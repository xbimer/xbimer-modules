...
public:
	...
	virtual CAT::CategoryValueConstRef			GetCategoryValue (const EDB::GeneralElemConstRef& elem) const override final;

private:
	CAT::CategoryValueConstRef					CalcRetVal (const Phasing::RenovationStatusValueId* statusPtr) const;
