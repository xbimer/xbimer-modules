...
public:
	...
	void SetStencilLoadAction (uint8_t clearstencil, LoadAction loadaction) override;
...
private:
	OpenGLResourceFactory*	creator;
	OpenGLRenderingContext*	boundcontext;
...
public:
	...
	// specific
	void BoundInContext (OpenGLRenderingContext* context);
	void UnboundInContext (OpenGLRenderingContext* context);
};
