...
public:
	...
	void	FrameRect (const GS::Rect<float>& rect);
	void	FrameRoundedRect (const GS::Rect<float>& rect, float cornerRadius);
	...
	void	FillRect (const GS::Rect<float>& rect, const Gfx::Color& color);
