...
public:
	...
	*/
	PrettyWriter(Stream& stream, Allocator* allocator = 0, int numberofDigits = Base::kDefaultNumberOfDigits, size_t levelDepth = Base::kDefaultLevelDepth) : 
		Base(stream, allocator, numberofDigits, levelDepth), indentChar_(' '), indentCharCount_(4) {}
