...
private:
	...
	template <AnyCapabilities::Flags C>
...
public:
	...
	template <class Type, class... Args>
	GenericAny (TypedInPlaceSelector<Type>, Args&&... args);
...
template <AnyCapabilities::Flags Cap>
template <class Type, class... Args>
GenericAny<Cap>::GenericAny (TypedInPlaceSelector<Type>, Args&&... args)
{
