...
template <class Type, USize Size>
inline typename FixArray<Type, Size>::ReverseRange	FixArray<Type, Size>::Reverse (void)
{
	return { *this };
}
...
template <class Type, USize Size>
inline typename FixArray<Type, Size>::ReverseConstRange		FixArray<Type, Size>::Reverse (void) const
{
	return { *this };
}
