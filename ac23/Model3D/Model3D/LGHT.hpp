...
class MODEL3D_CPP_DLL_EXPORT LGHT {
	friend MODEL3D_DLL_EXPORT GSErrCode Store (GS::ObjectState& os, const LGHT& elem);
	friend MODEL3D_DLL_EXPORT GSErrCode Restore (const GS::ObjectState& os, LGHT& elem);
	friend MODEL3D_DLL_EXPORT GSErrCode Write (GS::OChannel& oc, const LGHT& elem);
	friend MODEL3D_DLL_EXPORT GSErrCode Read (GS::IChannel& ic, LGHT& elem);
public:
	short						ltype;
