...
private:
	...
	STATL				status;
	GSAttributeIndex	iumat;				/* Material or light index				*/
...
public:
	...
	void				SetMaterialIndex (GSAttributeIndex iumat)	{ this->iumat = iumat; }
	GSAttributeIndex	GetMaterialIndex () const					{ return iumat; }
