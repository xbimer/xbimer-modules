...
private:
	...
	GSAttributeIndex	m_iumat;		// material index. can be used: for surfaces (polygons) created by cut
	short	m_btype;
...
public:
	...
	void		SetAllPolygonMaterialIdx	(GSAttributeIndex mat);
...
public:
	...
	Coord3D GetVertexPoint (ULong index, const TRANMAT& trafo = Geometry::IdentityTranMat) const;	// RECOMMENDED: Body-relative, starts from 0
...
public:
	...
	void	SetMaterialIdx	(GSAttributeIndex materialIdx)	{ m_iumat = materialIdx; }
	void	SetEdgePenIdx	(short edgePenIdx)	{ m_edgePenIdx = edgePenIdx; }
	void	MergeMaterial	(GSAttributeIndex materialIdx);
	...
	void	OverwriteMaterials (const GS::Array<GSAttributeIndex>* iumatPerPoly, GSAttributeIndex defaultIumat);
	...
	GSAttributeIndex	GetMaterialIdx (void) const		{ return m_iumat; }
...
public:
	...
	Int32	StorePolygon (GSAttributeIndex iumat, Wrapping tproj, Int32 irtxt, Int32 mpuid, Int32 ivect, Int32 npedg, Int32 *ipedg, const GS::Array<double>* tParams, STATL status);
	ULong	StoreAndCheckCompletePolygon (GSAttributeIndex iumat, Wrapping tproj, Int32 itxtu, Int32 npedg, Int32* ipedg, const GS::Array<double>* tParams, STATL pstat, bool ncheck);
	ULong	StorePolygonWithPolyEdges (GSAttributeIndex iumat, Wrapping tproj, Int32 irtxt, Int32 ivect, Int32 npedg, Int32* ipedg, const GS::Array<double>* tParams, STATL pstat);
