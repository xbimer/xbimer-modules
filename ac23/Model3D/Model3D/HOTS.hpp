...
class MODEL3D_DLL_EXPORT HOTS {
	...
	friend MODEL3D_DLL_EXPORT GSErrCode Store (GS::ObjectState& os, const HOTS& elem);
	friend MODEL3D_DLL_EXPORT GSErrCode Restore (const GS::ObjectState& os, HOTS& elem);
	friend MODEL3D_DLL_EXPORT GSErrCode Write (GS::OChannel& oc, const HOTS& elem);
	friend MODEL3D_DLL_EXPORT GSErrCode Read (GS::IChannel& ic, HOTS& elem);
