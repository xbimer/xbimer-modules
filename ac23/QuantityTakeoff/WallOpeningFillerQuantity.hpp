...
class QUANTITYTAKEOFF_DLL_EXPORT_FOR_TEST WallOpeningFillerQuantityCalculator : public Property::IWallOpeningFillerQuantityCalculator, protected VBModelElemQuantityCalculator
{
public:
	WallOpeningFillerQuantityCalculator (const VBElem::ModelElementConstRef& vbElem, const QuantityModelConstPtr& quantityModel);
	virtual ~WallOpeningFillerQuantityCalculator ();
...
private:
	...
	const VBElem::WallOpeningFillerConstRef&	GetWallOpeningFiller () const;
};
