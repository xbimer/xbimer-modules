...
#ifndef STAIRSTRUCTURE_QUANTITY_HPP
#define STAIRSTRUCTURE_QUANTITY_HPP
...
#include "IStairStructureQuantityCalculator.hpp"
...
class QUANTITYTAKEOFF_DLL_EXPORT_FOR_TEST StairStructureQuantityCalculator : public Property::IStairStructureQuantityCalculator, protected VBModelElemQuantityCalculator
{
public:
	StairStructureQuantityCalculator (const VBElem::ModelElementConstRef& vbElem, const QuantityModelConstPtr& quantityModel);
	virtual ~StairStructureQuantityCalculator ();

	virtual double											GetHeight							() const override;
	virtual double											Get3DLength							() const override;
...
private:
	...
	const VBElem::StairStructureConstRef& GetStairStructure () const;
};
