...
public:
	...
	virtual double											GetHighestPoint						() const = 0;
	virtual double											GetLowestPoint						() const = 0;

	virtual GS::HashSet<VBEO::ModelElemComponentId>			GetComponents						() const = 0;
	virtual	ADB::AttributeIndex								GetComponentBuildingMaterialIdx		(const VBEO::ModelElemComponentId& componentId) const = 0;
