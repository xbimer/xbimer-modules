...
public:
	...
	virtual void		RemoveUnusedDependentObjects			(ODB::ConstRefList<ODB::Object>&			sourceObjectSet,
																 SRM::ISourceElemFilter*					sourceElemFilter) override;
	...
	virtual bool		HasCommonProxyCacheObjects				(ODB::ConstRef<TW::Object>					cacheRootObject,
																 SRM::CommonProxySubsetMark					subsetMark) override;

	virtual void		AppendCommonProxyCacheObjects			(ODB::ConstRef<TW::Object>					cacheRootObject,
																 SRM::ConstRefSet&							commonProxyCacheObjects,
																 SRM::CommonProxySubsetMark					subsetMark) override;
	...
	virtual GSErrCode	BindToProjectForCacheSave				(ODB::ConstRef<TW::Object>					cacheRootObject,
																 ...
																 const SRM::IdTable&						cacheToSourceMapTable,
																 ObjectsToProcessAfterDBMerge&				objectsOfMergedAttributes) override;
...
public:
	static GSErrCode	CreateClassificationSystemContainerSetInOldCache	(REM::Project* project, SRM::ReferenceElemCacheRef cache);
};
