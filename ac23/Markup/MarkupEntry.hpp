...
private:																														 \
	...
	ADB::AttributeIndex			styleIndex;			/* style to apply on elements upon draw */									 \
...
public:
	...
	MarkupEntry (EDB::FloorRef				floor,
				 ...
				 const ADB::AttributeIndex&	styleIndex,
...
public:
	...
	inline const ADB::AttributeIndex&	GetStyleIndex		(void) const										{ return styleIndex;  }
	...
	static void							GetElementPainterEntries	(EDB::GeneralElemRef elem, ODB::RefList<PRMU::MarkupEntry>* list);
		   ...
		   void							SetStyleReference	(const ADB::AttributeIndex& styleIndex);
